...
.Polaris-Banner__SecondaryAction_1dl4i:focus > .Polaris-Banner__Text_yj3uv { padding: 0.125rem 0.3125rem; margin: -0.125rem -0.3125rem; background: var(--p-action-secondary-hovered); border-radius: 0.1875rem; box-shadow: none; }
...
.Polaris-Banner__Text_yj3uv { box-shadow: 0 -0.125rem 0 0 rgba(var(--p-rgb-text), 0.25) inset; -webkit-backface-visibility: hidden; backface-visibility: hidden; will-change: box-shadow; transition: box-shadow 200ms cubic-bezier(0.25, 0.1, 0.25, 1); }
